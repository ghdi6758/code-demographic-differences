...
with open("./result_all/usonly_CF_aggregated_all.txt","w") as output:
    ...
    list_files = ["./result_1_20160725/1st_CF_aggregated_all.csv", "./result_2_20160731/2nd_CF_aggregated_all.csv"]
