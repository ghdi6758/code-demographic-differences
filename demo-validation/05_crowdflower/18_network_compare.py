...
output_all = open("./link_analysis/link_analysis.txt", "w")
output_image = open("./manual_inspection_images_link_analysis.txt", "w")
...
for test_method in list_test_method:
    ...
    for param in list_param:
        for pred_param in list_pred_param:
            ...
            screenname2cfrace = {}
            screenname2line = {}
            with open("./2nd_round_CF_aggregated_all.txt") as fi:
                for line_cnt, line in enumerate(fi):
            ...
            with open("./network_random_screenname_faceplusplus_name_imageurl.txt") as fi:
                for line_cnt, line in enumerate(fi):
            ...
            with open("./network_stillonline_random_screenname_faceplusplus_name_imageurl.txt") as fi:
                for line_cnt, line in enumerate(fi):
            ...
            for city in cities:
                ...
                outputfilename = "withcfrace_random_inferred_users_follower_network_%s.txt" % (city)
            ...
            # print "original users from links"
            # for city in cntusers:
            #     print city, len(cntusers[city])

            # print "stillonline and cf_conf > 0.5"
            # for city in cntusers_stillonline:
            #     print city, len(cntusers_stillonline[city])
            ...
            cities = ["NY", "texas"]
            for city in cities:
                inputfilename = "withcfrace_random_inferred_users_follower_network_%s.txt" % (city)
                ...
                with open(inputfilename) as fi:
                    ...
                    # print "F++ Race"
                    # print "\t".join(["", "white", "black", "asian"])
                    # for from_race in ["white", "black", "asian"]:
                    #     myresult = [from_race]
                    #     for to_race in ["white", "black", "asian"]:
                    #         myresult.append(str(cnt_fprace[from_race][to_race]))
                    #     print"\t".join(myresult)
                    ...
                    #     if fprace_total[from_race] == 0:
                    #         continue
                    #     myresult_perc  = [from_race]
                    #     for to_race in ["white", "black", "asian"]:
                    #         myresult_perc.append("%.3f" % (float(cnt_fprace[from_race][to_race])/float(fprace_total[from_race])*100.0))
                    #     print"\t".join(myresult_perc)
                    ...
                    #     myresult = [from_race]
                    #     for to_race in ["white", "black", "asian"]:
                    #         myresult.append(str(cnt_cfrace[from_race][to_race]))
                    #     print"\t".join(myresult)
                    ...
                    #     if cfrace_total[from_race] == 0:
                    #         continue
                    #     myresult_perc  = [from_race]
                    #     for to_race in ["white", "black", "asian"]:
                    #         myresult_perc.append("%.3f" % (float(cnt_cfrace[from_race][to_race])/float(cfrace_total[from_race])*100.0))
                    #     print"\t".join(myresult_perc)

            print "\n\n"

            # with open("./link_analysis/link_analysis_CF_%s_%s_%s.txt" % (param,test_method,pred_param), "w") as output:
