...
infilename <- sprintf("compare_conf.txt", city)
...
for (city in c("NY", "Texas")) {
  ...
  for (myrace in c("white", "black", "asian", "hispanic")) {
    ...
    ggsave(sprintf("plots/byrace_compare_fpp2cf_group82_%s_%s.png", city, myrace), height=8, width=5)
    ggsave(sprintf("plots/byrace_compare_fpp2cf_group82_%s_%s.pdf", city, myrace), height=8, width=5)
    ...
    ggsave(sprintf("plots/byrace_compare_cf2fpp_group3_%s_%s.png",city,myrace), height=8, width=5)
    ggsave(sprintf("plots/byrace_compare_cf2fpp_group3_%s_%s.pdf",city,myrace), height=8, width=5)
  }
}
