...
output = open("./user_time_tweetid_hashtag_lower_texas_2.txt", "w")
output_tweets = open("./tweets_texas_2.txt", "w")
...
with open("./crawled_users_screen_name_texas_2.txt", "w") as output_users:
    for screen_name in allusers:
        output_users.write(screen_name + "\n")
