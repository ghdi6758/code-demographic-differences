...
set output 'tweets_coverage_newyork.eps'
set xlabel 'ntweets in dataset / ntweets in bio'
set ylabel 'CDF'
#set yrange[0.3:1]
#set xrange[0:1]
...
plot "./tweets_coverage_newyork.cdf" using ($1):($2) t 'New York' w l ls 1, \
"../05_tweets_texas/tweets_coverage_texas.cdf" using ($1):($2) t 'Texas' w l ls 3,
